...
<body>
    <section>
        <h3 style="text-align: center"><b>MANAGER DETAILS</b></h3>
        <div class="tbl-header">
        
        <%
            AdminService service = new AdminServiceImpl();
            List<Employee> managerList = service.viewallmanagers();
        %>
             ...
             %>
                ...
                <tbody>
                    <tr>
                        ...
                        <a href="managerdeletion.jsp?id=<%=  emp.getId() %>"><button type="submit" class="rounded-delete-btn"><i class="material-icons">delete</i></button></a>
